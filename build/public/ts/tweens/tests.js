...
export const tests = {
  ...
  'TWEEN object stores tweens automatically on start'(test) {
  ...
  'TWEEN.update() returns false when done (no tweens to animate)'(test) {
    TWEEN.removeAll();
    test.deepEqual(TWEEN.update(), false);
    test.done();
  },

  'TWEEN.update() returns true when there are active tweens'(test) {
    TWEEN.removeAll();
    const t = new TWEEN.Tween({});
    t.start();
  ...
  'TWEEN.update() removes tweens when they are finished'(test) {
    TWEEN.removeAll();
  ...
  'TWEEN.update() does not remove tweens when they are finished with preserve flag'(test) {
    TWEEN.removeAll();
    const t1 = new TWEEN.Tween({}).to({}, 1000),
          t2 = new TWEEN.Tween({}).to({}, 2000);
    test.equal(TWEEN.getAll().length, 0);
  ...
  'Unremoved tweens which have been updated past their finish time may go backward in time'(test) {
    TWEEN.removeAll();
    const target1 = {
      a: 0
    };
    ...
    const t1 = new TWEEN.Tween(target1).to({
      a: 1
    }, 1000),
          t2 = new TWEEN.Tween(target2).to({
      b: 1
    }, 2000);
    t1.start(0);
    t2.start(0); // To be able to make a tween go backward in time, it must be
  ...
  'Return the same tween instance for method chaining'(test) {
    const t = new TWEEN.Tween({});
  ...
  'Tween non-existing property'(test) {
    const obj = {
      x: 1
    },
          t = new TWEEN.Tween(obj);
    ...
    t.start(0);
    t.update(1000);
    test.deepEqual(obj.x, 1); // eslint-disable-next-line
    // @ts-ignore
  ...
  'Tween undefined property'(test) {
    ...
    t.start(0);
    t.update(1000); // eslint-disable-next-line
    // @ts-ignore
  ...
  'Tween relative positive value'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'Tween relative negative value'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'String values without a + or - sign should not be interpreted as relative'(test) {
    const obj = {
      x: 100
    },
          t = new TWEEN.Tween(obj);
  ...
  'Tween relative positive value, with yoyo'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'Tween relative negative value, with yoyo'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'Tween relative positive array interpolation values'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'String values without a + or - sign should not be interpreted as relative with array interpolation values'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'animate values in an array'(test) {
    const obj = [0, 0, 0],
          t = new TWEEN.Tween(obj);
  ...
  'animate values in a nested array'(test) {
    const obj = {
      a: [0, 0, 0]
    },
          t = new TWEEN.Tween(obj);
  ...
  'Ensure tweens start without calling start() method.'(test) {
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj);
  ...
  'Test Tween.to() tweening towards a dynamic object'(test) {
    const rabbit = {
      x: 1000,
      y: 0
    };
  ...
  'Test TWEEN.Tween.chain --with one tween'(test) {
    const t = new TWEEN.Tween({}),
          t2 = new TWEEN.Tween({});
    let tStarted = false,
        tCompleted = false,
  ...
  'Test TWEEN.Tween.chain --with several tweens in an array'(test) {
    const t = new TWEEN.Tween({}),
          chainedTweens = [],
          numChained = 3;
  ...
  'Test TWEEN.Tween.chain allows endless loops'(test) {
    const obj = {
      x: 0
    },
          t1 = new TWEEN.Tween(obj).to({
      x: 100
    }, 1000),
          t2 = new TWEEN.Tween(obj).to({
      x: 0
    }, 1000);
    TWEEN.removeAll();
    t1.chain(t2);
    t2.chain(t1);
    test.equal(obj.x, 0); // x == 0

    t1.start(0);
    TWEEN.update(0);
    test.equal(obj.x, 0);
    TWEEN.update(500);
    test.equal(obj.x, 50); // there... (x == 100)

    TWEEN.update(1000);
    test.equal(obj.x, 100);
    TWEEN.update(1500);
    test.equal(obj.x, 50); // ... and back again (x == 0)
    ...
    const t3 = new TWEEN.Tween(obj2).to({
      x: 200
    }, 1000);
    const t4 = new TWEEN.Tween(obj2).to({
      x: 100
    }, 1000);
    t4.chain(t3);
    t3.chain(t4);
  ...
  'Test TWEEN.Tween.onUpdate'(test) {
    const obj = {},
          t = new TWEEN.Tween(obj);
    let counter = 0;
    t.to({
  ...
  'Test TWEEN.Tween.onComplete'(test) {
    const obj = {},
          t = new TWEEN.Tween(obj);
    let counter = 0;
    t.to({
  ...
  'TWEEN.Tween does not repeat by default'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj).to({
      x: 100
    }, 100);
    t.start(0);
    TWEEN.update(0);
  ...
  'Test single repeat happens only once'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test Infinity repeat happens forever'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test tweening relatively with repeat'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0,
      y: 0
  ...
  'Test yoyo with repeat Infinity happens forever'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test yoyo with repeat 1 happens once'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test yoyo works with arrays'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test yoyo can be stopped and restarted properly'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test TWEEN.Tween.stopChainedTweens()'(test) {
    const t = new TWEEN.Tween({}),
          t2 = new TWEEN.Tween({});
    let tStarted = false,
        tCompleted = false,
  ...
  'Test TWEEN.Tween.chain progressess into chained tweens'(test) {
    const obj = {
      t: 1000
    }; // 1000 of nothing

    const blank = new TWEEN.Tween({}).to({}, 1000); // tween obj.t from 1000 -> 2000 (in time with update time)

    const next = new TWEEN.Tween(obj).to({
      t: 2000
    }, 1000);
  ...
  'Test that TWEEN.Tween.end sets the final values.'(test) {
    const object1 = {
      x: 0,
      y: -50,
      z: 1000
  ...
  'Test that TWEEN.Tween.end calls the onComplete callback of the tween.'(test) {
    test.expect(1);
    const tween1 = new TWEEN.Tween({}).to({}, 1000).onComplete(function () {
      test.ok(true);
    });
    tween1.start();
    tween1.end();
  ...
  'Ensure Tween.end() works after stopping a tween.'(test) {
    const object = {
      x: 0,
      y: -50,
      z: 1000
  ...
  'Test delay adds delay before each repeat'(test) {
  ...
  'Test repeatDelay adds delay before each repeat'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
  ...
  'Test repeatDelay and delay can be used together'(test) {
    TWEEN.removeAll();
    const obj = {
      x: 0
    },
          t = new TWEEN.Tween(obj).to({
      x: 100
    }, 100).delay(100).repeat(1).repeatDelay(200);
    t.start(0);
    TWEEN.update(100);
    test.equal(obj.x, 0);
    TWEEN.update(150);
  ...
  'Tween.js compatible with Object.defineProperty getter / setters'(test) {
    const obj = {
      _x: 0,
      x: 0
    };
    ...
    test.equal(obj.x, 0);
    const t = new TWEEN.Tween(obj).to({
      x: 100
    }, 100);
    t.start(0);
    test.equal(obj.x, 0);
  ...
  'tween.isPlaying() is false before the tween starts'(test) {
    TWEEN.removeAll();
    const t = new TWEEN.Tween({
      x: 0
    }).to({
  ...
  'tween.isPlaying() is true when a tween is started and before it ends'(test) {
    TWEEN.removeAll();
    const t = new TWEEN.Tween({
      x: 0
    }).to({
  ...
  'tween.isPlaying() is false after a tween ends'(test) {
    TWEEN.removeAll();
    const t = new TWEEN.Tween({
      x: 0
    }).to({
  ...
  'A zero-duration tween finishes at its starting time without an error.'(test) {
    TWEEN.removeAll();
    const object = {
      x: 0
    };
  ...
  'Custom group.getAll()'(test) {
    const group = new TWEEN.Group();
    test.ok(group.getAll() instanceof Array);
    test.done();
  },

  'Custom group stores tweens instead of global TWEEN group'(test) {
    const group = new TWEEN.Group();
  ...
  "Custom group.removeAll() doesn't conflict with global TWEEN group"(test) {
    const group = new TWEEN.Group();
    TWEEN.removeAll();
    group.removeAll();
  ...
  "Global TWEEN.removeAll() doesn't conflict with custom group"(test) {
    const group = new TWEEN.Group();
    TWEEN.removeAll();
    group.removeAll();
    test.equal(TWEEN.getAll().length, 0, 'No global tweens left');
  ...
  "Custom group.add() doesn't conflict with global TWEEN group, or vice versa"(test) {
    const group = new TWEEN.Group();
    const globalTween = new TWEEN.Tween({});
    const groupTweenA = new TWEEN.Tween({}, group);
    const groupTweenB = new TWEEN.Tween({}, group);
  ...
  "Custom group.update() doesn't conflict with global TWEEN group"(test) {
    const group = new TWEEN.Group();
    const startObj = {
      x: 1
    };
  ...
  "Global TWEEN.update() doesn't conflict with custom group"(test) {
    const group = new TWEEN.Group();
    const startObj = {
      x: 1
    };
  ...
  'Ensure tweens work without any group'(test) {
    const obj = {
      x: 0
    },
  ...
  'Stopping a tween within an update callback will not cause an error.'(test) {
    TWEEN.removeAll();
  ...
  'Set the duration with .duration'(test) {
    const obj = {
      x: 1
    };
    const t = new TWEEN.Tween(obj).to({
  ...
  "Tween.group sets the tween's group."(test) {
    const group = new TWEEN.Group();
  ...
  'Test TWEEN.Tween.pause() and TWEEN.Tween.resume()'(test) {
    const obj = {
      x: 0.0
    },
          t = new TWEEN.Tween(obj);
    ...
    TWEEN.update(3000);
    test.equal(obj.x, 0.4);
    t.resume(3200); // values do not change until an update
  ...
  'Test TWEEN.Tween.pause() and TWEEN.Tween.resume(), without groups'(test) {
    const obj = {
      x: 0.0
    },
          t = new TWEEN.Tween(obj, false);
  ...
  'Arrays in the object passed to to() are not modified by start().'(test) {
    const start = {
      x: 10,
      y: 20
    };
  ...
  'Tween.js animate nested object'(test) {
    const obj = {
      scale: {
        x: 0
      },
  ...
  'Tween.js animate nested object including relative value'(test) {
    const obj = {
      world: {
        hero: {
          scale: {
  ...
  'Test TWEEN.Tween with nested objects'(test) {
    const obj = {
      x: 0.0,
      y: 100,
      some: {
  ...
  'Test TWEEN.Tween.pause() and .resume() with nested objects'(test) {
    const obj = {
      x: 0.0,
      y: 100,
      some: {
